...
onready var dialogo = [
	"Perfeito Dellman, voce esta indo muito bem em sua jornada, mas para alcancarmos mais um nivel de visão todos na equipe precisam estar crescendo em direção ao nosso objetivo. Poi isso, va ate o Jeff desinfcta-lo deste virus terrivel"
