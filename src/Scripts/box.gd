...
onready var dialogo = [
	"Para subirmos o nosso nivel de visão precisamos ter em mente aquilo que buscamos e entender como isso impacta em nosso projeto. Parabens Dellman, você esta mais perto de entender o que precisa ser feito!"
