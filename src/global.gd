...
var statusPreLobby = false
onready var stepPreLobbyHouse = 1
...
onready var dialogo = {"preLobbyRoomInstru01": ["Fale com todas as pessoas da sala"],
						...
						"preLobbyHouseRoomBlocked": ["Não é possível voltar para a sala anterior, fale com todas as pessoas dessa sala"],
						"InstructionsInit": ["Aperte espaço para pular o dialogo. \n \n \n Teclas para movimentação: \n 'W' para cima \n 'A' para movimentar par aesquerda \n 'S' para movimentar para baixo \n 'D' para movimentar para direita"],
						"preLobbyHouseWait": ["                                                        10 minutos depois..."],
						"preLobbyInstructionCloud": ["Fale com o Cloud"],
								...
								"preLobby": {
									"preLobby": {
										...
										"talk3": [
											...
											["Dellman", "I can help you in all what you need"],
											...
											["NPC2", "1- People that were usually active, creative, and open in their decisions began to close themselves and ignore what others said. "],
											["NPC2", "2- The ones who were collaborative, started behaving like, pardon the frugal wording, “pricks”."],
											["NPC2", "3- Everyone started to work for their own selves and benefits, individualism, in every sense of the word."],
											["NPC2", "So, in simple words, this is not something that’s happened out of nowhere, rather, it’s something that’s been created and spread across the whole island"],
